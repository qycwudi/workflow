...
# docker build --platform linux/amd64 -t workflow:v3-b10 .
# docker login --username=qiangyuecheng registry.cn-hangzhou.aliyuncs.com
# Qycssg00
# docker tag 48d72e2e77a9 registry.cn-hangzhou.aliyuncs.com/jenkins_construct_images/workflow:v3-b10
# docker push registry.cn-hangzhou.aliyuncs.com/jenkins_construct_images/workflow:v3-b10
