...
# docker build --platform linux/amd64 -t workflow:v3-b7 .
# docker login --username=qiangyuecheng registry.cn-hangzhou.aliyuncs.com
# Qycssg00
# docker tag 4c5e92e55074 registry.cn-hangzhou.aliyuncs.com/jenkins_construct_images/workflow:v3-b7
# docker push registry.cn-hangzhou.aliyuncs.com/jenkins_construct_images/workflow:v3-b7
