...
# docker build --platform linux/amd64 -t workflow:v3-b3 .
# docker login --username=qiangyuecheng registry.cn-hangzhou.aliyuncs.com
# Qycssg00
# docker tag 5853b7e1b471 registry.cn-hangzhou.aliyuncs.com/jenkins_construct_images/workflow:v3-b3
# docker push registry.cn-hangzhou.aliyuncs.com/jenkins_construct_images/workflow:v3-b3
