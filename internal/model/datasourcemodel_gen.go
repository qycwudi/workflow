...
func (m *defaultDatasourceModel) Insert(ctx context.Context, data *Datasource) (sql.Result, error) {
	...
	ret, err := m.conn.ExecCtx(ctx, query, data.Type, data.Config, data.Switch, data.Hash, data.Status, data.CreateTime, data.UpdateTime, data.Name, data.CreateBy)
	return ret, err
}
...
func (m *defaultDatasourceModel) Update(ctx context.Context, newData *Datasource) error {
	...
	_, err := m.conn.ExecCtx(ctx, query, newData.Type, newData.Config, newData.Switch, newData.Hash, newData.Status, newData.CreateTime, newData.UpdateTime, newData.Name, newData.CreateBy, newData.Id)
	return err
}
