<!-- 导出 -->
atlas schema inspect -u "mysql://root:root@14.103.249.105:30006/workflow_prod" --format '{{ sql . }}' > workflow_schema.sql

atlas schema inspect -u "mysql://root:Root@123@10.99.7.9:3306/flow" --format '{{ sql . }}' > workflow_schema.sql
